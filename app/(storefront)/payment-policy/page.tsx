...
export const metadata: Metadata = {
  title: "Payment Policy | 6K",
  description: "Accepted payment methods at 6K — secure prepaid payments via Razorpay.",
  openGraph: {
    title: "Payment Policy | 6K",
    description: "Accepted payment methods at 6K — secure prepaid payments via Razorpay.",
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-24 flex-grow w-full">
      ...
      <div className="space-y-8 text-sm text-outline leading-relaxed uppercase tracking-wider font-semibold">
        ...
        <section className="bg-surface-container-low p-8 border border-outline-variant/10">
          <h3 className="text-on-surface font-black text-lg mb-4">2. Payment Security &amp; Encryption</h3>
          <p>
        ...
        <section className="bg-surface-container-low p-8 border border-outline-variant/10">
          <h3 className="text-on-surface font-black text-lg mb-4">3. Order Confirmation</h3>
          <p>
        ...
        <section className="bg-surface-container-low p-8 border border-outline-variant/10">
          <h3 className="text-on-surface font-black text-lg mb-4">4. Failed Transactions &amp; Refunds</h3>
          <p>
        ...
        <section className="bg-surface-container-low p-8 border border-outline-variant/10">
          <h3 className="text-on-surface font-black text-lg mb-4">5. Fraud Prevention</h3>
          <p>
