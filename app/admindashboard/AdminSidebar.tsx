...
export default function AdminSidebar({ user, pendingReturnsCount, pendingOrdersCount, hasRecentAudit, children }: AdminSidebarProps) {
  ...
  return (
    <div className="bg-[#f9fafb] text-[#111827] font-body min-h-screen flex antialiased">
      ...
      <aside
        id="adminSidebar"
        className={`fixed inset-y-0 left-0 w-72 bg-[#0a0a0a] flex-col z-[60] transform -translate-x-full lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen transition-transform duration-300 ease-in-out flex shrink-0 overflow-y-auto min-h-0 ${
