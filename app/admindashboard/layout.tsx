      ...
      >
        ...
        <div className="p-6 bg-white/5 border-t border-white/10">
          <div className="flex items-center gap-4 mb-6">
            <div
              className="size-10 rounded-full border border-white/20 overflow-hidden grayscale bg-cover bg-center"
              style={{
                backgroundImage:
            ...
            ></div>
            <div>
              <p className="text-xs font-bold font-headline text-white">Workshop Manager</p>
          ...
          <Link
            href="/"
            className="flex items-center justify-center gap-2 w-full py-3 bg-white/10 text-[10px] font-black uppercase tracking-widest text-white hover:bg-[#fed488] hover:text-[#0a0a0a] transition-all"
          >
            Storefront <span className="material-symbols-outlined text-sm">open_in_new</span>
          </Link>
        </div>
      </aside>
